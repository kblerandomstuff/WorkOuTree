 ...
 * Use the {@link wod13Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class wod13Fragment extends Fragment {
    private DBHelper db;
    String woname = "Lunge Climber";
    public wod13Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db.insertContact("Lunge Climber",10);
